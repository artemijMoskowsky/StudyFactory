...
from course_app.views import render_course_creation, render_course_page, render_task_page, render_task_creation, render_delete_task, get_all_user_courses, render_course_connect, get_sort, render_finish_task, get_info_about_course
...
course_app.add_url_rule("/s", view_func=get_sort, methods=["POST", "GET"])
