...
from course_app.views import render_course_creation, render_course_page, render_task_page, render_task_creation, render_delete_task, get_all_user_courses, render_course_connect, render_finish_task
...
course_app.add_url_rule("/course_page/<int:ID>", view_func=render_course_page, methods=["POST", "GET"])
course_app.add_url_rule("/task_page/<int:ID>", view_func=render_task_page, methods=["POST", "GET"])
