...
from course_app.views import render_course_creation, render_course_page, render_task_page, render_task_creation, render_delete_task, render_course_connect, render_sort, render_finish_task
